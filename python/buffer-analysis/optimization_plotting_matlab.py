...
def optimization_plotting_matlab():
    ...
    """It can be seen that the optimal dimensioning factors generated by MATLAB follow a trend in the delay range 
    almost very similar to that generated by the scipy.minimise optimisation algorithm."""
